  ...
  return (
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="max-w-2xl w-full">
        ...
        <div
          className={`upload-area rounded-lg p-8 text-center transition-all duration-300 ${
            dragOver ? 'drag-over' : ''
          }`}
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          ...
          <div className="p-4">
            ...
            <h4 className="font-semibold text-foreground mb-1">2. Process</h4>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="p-4">
            ...
            <h4 className="font-semibold text-foreground mb-1">3. Learn</h4>
            <p className="text-sm text-muted-foreground">
